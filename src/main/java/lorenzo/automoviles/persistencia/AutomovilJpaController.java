package lorenzo.automoviles.persistencia;
...
import lorenzo.automoviles.persistencia.exceptions.NonexistentEntityException;
...
public class AutomovilJpaController implements Serializable {
    ...
    public AutomovilJpaController(){
        emf = Persistence.createEntityManagerFactory("AutomovilPU");
    }
